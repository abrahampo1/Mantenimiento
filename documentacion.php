...
function defaultConfig(){
	...
	$config['checks'] = array(
	     ...
	     'Ejemplo testeando el mac |headline',
	 ...
	 '-------------------------------------------------',
	    'Ejemplos over internet 👌👌👌|headline',
	 'www.marca.com| 80|www.marca.com',
...
function html($cache){
	...
	if ($config['datetime']) echo '<p class="datetime">' . date($config['datetime']) . "</p>\n";
